...
7. Now, send a GET request through "/sign-up" route to the specified port and in body send the user details(username, password, email and age) in an object 
8. Ensure you meet the required input constraints otherwise you will get a response "Invalid input"
9. Constraints :- username - has to be unique other you will get response saying "User already exists"
...
10. After sending the correct input you will get back a JWT toke, you can use this to sign in again
11. Send a post request with the JWT token and password in headers and if it is correct you will get a response saying "logged in"
12. Thus you can be signed in by the only unique JWT token given to you after creating an account and otherwise not
